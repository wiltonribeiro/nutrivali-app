...
class GoodFood extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Container(margin: EdgeInsets.only(left: 10, right: 10, bottom: 20), padding: EdgeInsets.all(20), width: double.infinity, decoration:
      new BoxDecoration(color: Colors.white, borderRadius: BorderRadius.all(Radius.circular(10)), boxShadow: [new BoxShadow(color: Color(0x4200f091), blurRadius: 2.0, offset: new Offset(0.0, 5.0))]), child:
        new Row(children: <Widget>[
          new Align(alignment: Alignment.center, child: new Image.asset("assets/graphics/doughnut.png", width: 60, height: 60)),
          new Expanded(child:
              new Padding(padding: EdgeInsets.only(left: 10, right: 10), child:
                new Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                  new Padding(padding: EdgeInsets.only(bottom: 10), child: new Text("$_title", style: TextStyle(fontSize: 20, color: Color(0xFF00f091)), textAlign: TextAlign.left)),
